        ...
        postprocess: (util) => {
            ...
            util.entries.forEach((i) => {
                ...
                if (value && typeof value === 'string') {
                    if (mode === 'rem2rpx' && remRE.test(value)) { i[1] = rem2rpx(value, baseFontSize, screenWidth) }
                    if (mode === 'rpx2rem' && rpxRE.test(value)) { i[1] = rpx2rem(value, baseFontSize, screenWidth) }
                }
            })
        },
    }
